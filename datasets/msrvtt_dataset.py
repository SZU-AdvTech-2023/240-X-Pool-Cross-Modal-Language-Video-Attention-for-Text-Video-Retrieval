...
class MSRVTTDataset(Dataset):
    ...
    def __init__(self, config: Config, split_type = 'train', img_transforms=None):
        ...
        db_file = '/data/weixiaojing/x-pool/MSRVTT/MSRVTT_data.json'
        test_csv = '/data/weixiaojing/x-pool/MSRVTT/MSRVTT_JSFUSION_test.csv'

        if config.msrvtt_train_file == '7k':
            train_csv = '/data/weixiaojing/x-pool/MSRVTT/MSRVTT_train.7k.csv'
        else:
            train_csv = '/data/weixiaojing/x-pool/MSRVTT/MSRVTT_train.9k.csv'
